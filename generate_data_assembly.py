...
for d in divisor:
    for seed in seed_list:
        ...
        print("num_parameters:", num_para, "seed", seed)

        data_mean, data_std = np.load(f'/home/mila/z/zixiang.huang/scratch/ps_trash/brainscore_data/resnet18_imagenet32_p{num_para}_s{seed}.npy')
        print(data_mean)
        mean_score_list.append(data_mean)
        parameters_list.append(num_para)

np.save('resnet18_imagenet32_simclr_meanscore_3seeds.npy', np.array(mean_score_list))
np.save('resnet18_imagenet32_simclr_para_3seeds.npy', np.array(parameters_list))
